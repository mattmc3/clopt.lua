...
describe("opt parser", function()
	...
	it("handles grouped short flags", function()
		local opts = opt.new_optset()
		opts:opt("a", "a", false, function(n) table.insert(parsed.flags, n) end, "A flag")
		opts:opt("b", "b", false, function(n) table.insert(parsed.flags, n) end, "B flag")
		opts:opt("c", "c", false, function(n) table.insert(parsed.flags, n) end, "C flag")
	...
	it("rejects grouped options when value arg is in middle", function()
		local opts = opt.new_optset()
		opts:opt("a", "a", false, function(n) table.insert(parsed.flags, n) end, "A flag")
		opts:opt("b", "b", true, function(n, v) parsed.args[n] = v end, "B option")
	...
	it("errors if long option missing argument", function()
		local opts = opt.new_optset()
		opts:opt("bar", nil, true, function(n, v) parsed.args[n] = v end, "Bar option")
	...
	it("handles multiple mixed arguments", function()
		local opts = opt.new_optset()
		opts:opt("a", "a", false, function(n) table.insert(parsed.flags, n) end, "A flag")
		opts:opt("l", "l", false, function(n) table.insert(parsed.flags, n) end, "L flag")
		opts:opt("o", "o", true, function(n, v) parsed.args[n] = v end, "Output file")
	...
	it("handles value option at end of grouped short flags", function()
		local opts = opt.new_optset()
		opts:opt("x", "x", false, function(n) table.insert(parsed.flags, n) end, "X flag")
		opts:opt("o", "o", true, function(n, v) parsed.args[n] = v end, "Output file")
	...
	it("last value wins for repeated long options", function()
		local opts = opt.new_optset()
		opts:opt("foo", nil, true, function(n, v) parsed.args[n] = v end, "Foo option")
	...
	it("handles grouped short flags with =value at end", function()
		...
		opts:opt("a", "a", false, function(n) table.insert(parsed.flags, n) end, "A flag")
		opts:opt("b", "b", false, function(n) table.insert(parsed.flags, n) end, "B flag")
		opts:opt("c", "c", true, function(n, v) parsed.args[n] = v end, "C option")
	...
	it("shows usage for all options", function()
		local opts = opt.new_optset()
		opts:opt("foo", "f", false, function() end, "Foo flag")
		opts:opt("bar", nil, true, function() end, "Bar option")
		opts:opt("baz", "z", true, function() end, "Baz option")
  ...
  -z, --baz <ARG>             Baz option
	...
	it("wraps help text for long flag names", function()
		local opts = opt.new_optset()
		opts:opt("really-long-flag-name-that-exceeds-width", "r", true, function() end, "This help should be wrapped to the next line.")
